(function () {
  ...
  const STRAIGHT_PAYOUT = rouletteMath && typeof rouletteMath.getPayoutMetadata === 'function'
    ? rouletteMath.getPayoutMetadata('straight').payout
    : 35;
  const EVEN_MONEY_PAYOUT = rouletteMath && typeof rouletteMath.getPayoutMetadata === 'function'
    ? rouletteMath.getPayoutMetadata('evenMoney').payout
    : 1;
  ...
  function isZeroPocket(value, wheelType) {
    if (rouletteMath && typeof rouletteMath.getWheelMetadata === 'function') {
      return rouletteMath.getWheelMetadata(wheelType).zeroLabels.indexOf(value) !== -1;
    }
